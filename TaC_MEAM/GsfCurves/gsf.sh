...
do
   ...
   mpirun -np 64 lmp -in gsf_112.in -var x_shift $i >> gsf.out
   mpirun -np 64 lmp -in gsf_110.in -var x_shift $i >> gsf.out
   mpirun -np 64 lmp -in gsf_111.in -var x_shift $i >> gsf.out
